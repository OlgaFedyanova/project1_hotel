...
public class Rooms {
    ...
    public static HashMap<Integer, List<String>> rooms = new HashMap<>(); //TODO почему здесь static?
    ...
    public void roomsList() {
        //TODO метод должен называться как глагол, например getRoomsList
    ...
    public static Rooms main() {
        //TODO метод main - это всегда точка входа, другие методы в другиих классах так называть не могут
        //TODO и метод должен называться по смыслу того что он делает, например здесь setRooms
