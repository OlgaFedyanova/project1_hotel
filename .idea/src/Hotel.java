...
public class Hotel {
 public static String FIO_NEW_GUEST = "Введите ФИО нового гостя: ";
    ...
    public static void main(String args[]) {
        ...
        int tag = 1;
        while (tag !=0) {
            //TODO: что здесь хотели сделать?
            tag = 0;
            Scanner in = new Scanner(System.in); //TODO: хардкод убираем в константы
            ...
            //TODO: что если пользователь введет букву или другую цифру? Как мы можем обработать такие ситуации?
            switch (tag){
                case (0):
                ...
                case (3):{
                    ...
                    System.out.println(FIO_NEW_GUEST); //TODO: хардкод убираем в константы
                ...
                case (7):{
                    Scanner id = new Scanner(System.in);
                    System.out.println("Введите id гостя: ");
                    Integer idGuest = id.nextInt(); //TODO: почему здесь используем Integer?
